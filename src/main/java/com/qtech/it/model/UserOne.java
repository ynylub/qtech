...
@Table(name = "user_one", schema = "qtech")
public class UserOne implements Serializable {
    ...
    // 有参 构造方法
    public UserOne(long id, String repair_date, String local_time, String department, String repair_user, String repair_phone, String repair_goods, String repair_number, String problem, String remarks, String receive_user, String receive_phone, String receive_date, String remarks2) {
        this.id = id;
